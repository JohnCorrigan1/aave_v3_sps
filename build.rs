...
fn main() -> Result<(), anyhow::Error> {
    // let file_names = ["abi/contract.abi.json", "abi/pool_config.abi.json"];
    // let file_output_names = ["src/abi/contract.rs", "src/abi/pool_config.rs"];
    let file_names = ["abi/erc20.abi.json"];
    let file_output_names = ["src/abi/erc20.rs"];
    ...
    for f in file_names {
        ...
        Abigen::from_bytes("PoolConfig", sanitized_abi_file.as_bytes())?
            .generate()?
