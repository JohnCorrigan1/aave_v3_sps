    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct MaxStableRateBorrowSizePercent {}
        impl MaxStableRateBorrowSizePercent {
            const METHOD_ID: [u8; 4] = [232u8, 47u8, 236u8, 47u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for MaxStableRateBorrowSizePercent {
            const NAME: &'static str = "MAX_STABLE_RATE_BORROW_SIZE_PERCENT";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for MaxStableRateBorrowSizePercent {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        ...
        impl ConfigureEModeCategory {
            const METHOD_ID: [u8; 4] = [213u8, 121u8, 234u8, 125u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                    ...
                    &[
                        ...
                        ethabi::Token::Tuple(
                            vec![
                                ...
                                .category.3)), ethabi::Token::String(self.category.4
                                .clone())
                            ],
                        ),
                    ],
        ...
        impl GetConfiguration {
            ...
            pub fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt,), String> {
                let mut values = ethabi::decode(
                        &[
                            ethabi::ParamType::Tuple(
                                vec![ethabi::ParamType::Uint(256usize)],
                            ),
                        ],
                        data.as_ref(),
                    )
            ...
            pub fn call(
                &self,
                address: Vec<u8>,
            ) -> Option<(substreams::scalar::BigInt,)> {
                use substreams_ethereum::pb::eth::rpc;
                let rpc_calls = rpc::RpcCalls {
                    calls: vec![
                        rpc::RpcCall { to_addr : address, data : self.encode(), }
        ...
        pub struct InitReserve {
            ...
            pub stable_debt_address: Vec<u8>,
            pub variable_debt_address: Vec<u8>,
            pub interest_rate_strategy_address: Vec<u8>,
        }
        impl InitReserve {
            const METHOD_ID: [u8; 4] = [122u8, 112u8, 142u8, 146u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.stable_debt_address),
                        ),
                        ethabi::Token::Address(
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(
                                &self.interest_rate_strategy_address,
                            ),
                        ),
                    ],
                );
        ...
        impl Initialize1 {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_logic),
                        ),
        ...
        impl substreams_ethereum::Function for Initialize1 {
            const NAME: &'static str = "initialize1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Initialize2 {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.provider),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl substreams_ethereum::Function for Initialize2 {
            const NAME: &'static str = "initialize2";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl RebalanceStableBorrowRate {
            const METHOD_ID: [u8; 4] = [205u8, 17u8, 35u8, 130u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for RebalanceStableBorrowRate {
            const NAME: &'static str = "rebalanceStableBorrowRate";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SwapBorrowRateMode {
            const METHOD_ID: [u8; 4] = [148u8, 186u8, 137u8, 162u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SwapBorrowRateMode {
            const NAME: &'static str = "swapBorrowRateMode";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        impl substreams_ethereum::Event for RebalanceStableBorrowRate {
            const NAME: &'static str = "RebalanceStableBorrowRate";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
        ...
        impl substreams_ethereum::Event for SwapBorrowRateMode {
            const NAME: &'static str = "SwapBorrowRateMode";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
